...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/HTTP-Cookies-Chrome> or 
L<MetaCPAN|http://www.metacpan.org/module/HTTP::Cookies::Chrome>:

=over 4

=item *	L<http://search.cpan.org/dist/HTTP-Cookies-Chrome>

=item *	L<http://www.metacpan.org/module/HTTP::Cookies::Chrome>
